      ...
      <div className="flex flex-1 flex-col gap-6 p-4 md:p-6">
        <Collapsible>
          <CollapsibleTrigger asChild>
            <div className="flex items-center justify-between w-full p-4 border rounded-lg cursor-pointer">
              <h2 className="text-lg font-semibold">Adicionar Operação</h2>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        value={formData.mep}
                        onChange={(e) =>
                          handleInputChange("mep", e.target.value)
                        }
                      />
                    </div>
                  </div>
